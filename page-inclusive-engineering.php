...
<link rel='stylesheet' href='<?php echo get_stylesheet_directory_uri() . '/immersive-stories/css/engineering.css?v=' . time() ?>' type='text/css' media='all' />
  ...
  <section class="text-block">
    ...
    <rect fill="#FFFFFF" width="14" height="3"/>
     ...
     <section class="text-block">
       ...
       <section data-vid="<?php echo get_stylesheet_directory_uri() . '/immersive-stories/video/engineering/pro' ?>" class='video-auto'>
          ...
          <div class="who-section">
              <ul id="people">
                  ...
                  <li class="pax-3" tabindex="0">
                      <div class="hider">
                          <h2>Dr. Jeff Ojemann</h2>
                          <p><span>Testbed Leader</span> / Center for Sensorimotor Neural Engineering</p>
