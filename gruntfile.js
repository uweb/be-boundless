module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      dist: {
        files: {
          ...
          'immersive-stories/js/task-force.min.js': [
              'immersive-stories/js/common.js',
              'js/libraries/prognroll.js',
              'immersive-stories/js/lity.js',
              'immersive-stories/js/slick.js',
        ...
        app: {
	        options: {
	         compress: true,
                ...
                'immersive-stories/custom/q-center.css': 'immersive-stories/custom/q-center.less'
        	    }
        },
        development: {
          files: {
    ...
    watch: {
      ...
      css : {
        files: ['less/*.less', 'immersive-stories/less/*.less', 'campaign/less/*.less', 'passion/less/*.less', 'immersive-stories/custom/*.less'],
        tasks: ['css']
      }
    }
  });
