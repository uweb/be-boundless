			...
			<div class="container copy">
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						...
						<p>그러나 전체 국가가 논문 주제는 아닙니다. 그녀는 어떻게 주제 범위를 좁힐 수 있었을까요? 권 연구원은 대학 도서관 시스템의 일부인 동아시아 도서관에서 답을 찾았습니다.</p>

						<p>학부 연구는 허스키 경험의 특징입니다 : 5 명의 UW 학부생 중 4 명이 연구, 창조적인 작업 또는 장학금에 참여합니다. 타코마에서 프라이데이 하버 지역에 걸쳐 16곳의 장소에 위치한 University Libraries는 모든 학부생의 연구를 돕기위해 수백만 권의 인쇄물과 디지털 컬렉션을 제공합니다.</p>

						<p>도서관은 또한 학생들에게 더욱 가치있는 자료를 제공합니다 : 사서, 기록보관담당자 및 큐레이터는 광범위한 주제에 대해 깊은 지식을 갖고 있으며 학부생이 연구 과정의 각 단계를 탐색하도록 도와줍니다.</p>
			...
			<div class="container copy">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 ">
						...
						<div class="row">
							<div class="col-md-6">
								<p>권 은 "모국에 대한 강한 자긍심을 느끼기 때문에 항상 한국을 연구하고 싶었지만 학문적으로 탐구 할 기회가 없었다"고 했습니다.   그래서 그녀는 그녀의 수석 졸업 논문의 방향을 결정하기가 쉬웠습니다. "물론, 나는 한국을 (주제로) 선택했습니다."</p>

								<p>그러나 다음 단계는 그리 단순하지 않았습니다. 권 은 연구 주제를 좁히기 위해 고심했습니다. 잭슨 국제 대학 부교수이며 권 의 논문 고문인 데보라 포터 (Deborah Porter) 교수는 권 이 한국 사회에서 여성의 역할을 연구하기위한 렌즈로 한국 드라마 (K-dramas)를 다뤄 볼 것을 제안했습니다.</p> 

								<p>미국 드라마와 마찬가지로 K-dramas는 진정한 사랑을 추구하는 이상적인 캐릭터를/인물들을 선보입니다. 67%에 가까운 한국 시청자가 90 년대 후반의 드라마 '너와 나'의 피날레를 지켜 보았고, 스페인에서 짐바브웨까지 관중들은 이 대단한 인기 쇼들에 매료되었습니다.   최초의 여성 왕가가 된 고아의 이야기를 다룬 드라마 "대장금"( “궁전의 보석")은 91 개국에 배포되었습니다.</p> 

								<p class="callout">"드라마는 한국의 중요한 문화"라고 권 은 말합니다. "나는 드라마를 보면서 자랐고, 내가 태어난 곳이기 때문에 나는 드라마들을 볼 때 소속감을 느낍니다."</p>

								<p>그러나 2016 년에 "아버지는 이상해" 에피소드를 보면서 권 은 좌절감이 커졌습니다.    "보통 한국 사회에서는 장남이 선호됩니다."라고 그녀는 설명합니다.  이 드라마는 오빠는 성공하지 못했지만 권위있는 대학을 졸업하고 성공한 변호사가 된 여성에 초점을 맞췄다 "고 설명했습니다.    그럼에도 불구하고, (권의 말에 따르면), 오빠의 잘못 행동은 가볍게 다루어졌지만 딸은 더 엄격한 벌을 받았다고합니다.   이러한 불균형은 그녀를 잠시 생각하게 만들었습니다.</p>

								<p>한국 여성들은 특히 직장에서 평등을 향한 커다란 진보를 이루었습니다. 그럼에도 불구하고, 많은 젊은 전문직 여성들이 보다 보수적인 역할을 묘사하는 드라마를 보고 있습니다. 그녀의 논문 프로젝트를 위해 권 은 명백한 역설과 그 경제적 사회적 영향을 조사하기로 결정했습니다.</p>

								<p>그녀의 논문의 전제는/가설은 근대 한국 여성들은 드라마 속의 한국 여성들의 보수적 세계와 그들이 성장하고 교육받은 진보적인 현실을 차별화 할 수 있기 때문에 K- 드라마를 보거나 감상 할 수 있다고 주장합니다.</p>
					...
					<div class="col-md-10 col-md-offset-1 ">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<p>Kwon은 가설을 정한 후 기존의 K- 드라마 소비에 관한 연구를 읽기 시작했습니다.   많은 자료들이 한국어 데이터베이스를 통해서만 이용 가능했지만, 그녀는 접속/액세스하거나 탐색하는 방법을 모르고 있었습니다. 그래서 권은 동아시아 도서관에 도움을 청했습니다.</p>

								<p>시애틀의 UW 캠퍼스에 위치한 동아시아 도서관은 전국에서 두 번째로 큰 한국어 컬렉션을 포함하여 770,000 권 이상을 보관하고 있습니다.</p>

								<p>한국인 도서관원/사서인 이효경 씨는 권 과 긴밀히 협력하기 시작했습니다. "첫 만남부터 나는 논문에 대한 그녀의 큰 호기심과 열정을 볼 수 있었다"고 이씨는 말합니다. KISS 한국어 자료 데이터베이스를 비롯한 온라인 자료를 탐색하여 권 이 필요로하는 자료를 함께 찾았습니다.</p>

								<p class="callout">"몇/많은 시간이 걸렸지만,이 선생님은 저를 열정적으로 도와주셨습니다/나를 돕는 것에 열정적이셨습니다." 권 은 말합니다. "나는 그 분의 헌신에 정말 감사했습니다."</p>

								<p>Kwon은 이용 가능한 자료들을 자세히 찾아 본 뒤/샅샅이 뒤지고 난 후,  한국 여성들을 인터뷰 하면서 자료를 수집하기위해 서울로 여행하기로 결정했습니다. 이 여행은 또한 그녀가 10년 넘게 보지 못했던 할머니와 친척들을/(숙모/고모/이모들을) 다시 볼 수 있는 기회를 줄 것입니다.</p>
			...
			<div class="container copy">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 ">
						...
						<div class="row">
							<div class="col-md-6">
								<p>권 은 서울에서 자신의 시간을 최대한 활용하기 위해 한국어 구사력을 향상시키고 그녀의 연구/탐구 방법이 한국 사회의 규범에 어긋나지 않도록 노력하고 싶었습니다./사회 규범과 충돌하지 않도록 노력하고 싶었습니다.</p>

								<p>한국에 자주 가는/여행하는 이 사서는 문화적인 면에 대해 권 이 준비하는 것을 기꺼이 도왔습니다. 그녀는 또한 권 양을 잭슨 학교 한국학 및 역사 학부의 남화숙, 제임스 B. 팔레리스 (James B. Palais) 부교수에게 소개했습니다. 권 교수는 권 을 이화 여자 대학교의 동료와 연결시켜 주어 대학 수업을 참관하고 인터뷰 참가자를 모집 할 수 있도록 했습니다.</p>

								<p class="callout">2017 년 9 월 경 권 은 한국을 방문 할 준비가 되었습니다. 그녀는 2 주 동안 그녀의 연구를 위해 한국 여성들과 인터뷰하고 가족을 방문 했습니다. 남 교수와 이 도서관원/사서로부터 받은 도움 덕분에 모든 대화가 순조롭게 진행되었습니다.</p>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<h2>그녀의 논문을/논제를 시험하다</h2>
								<p>그녀의 여행에 많은 비중이 주어졌습니다:  그녀는 몇 달 동안 인터뷰를 분석하면서 그녀가 수집 한 자료가 그녀의 가설을 완전히 반박하는 것을 발견할 수도 있습니다.</p>

								<p>권의 졸업 논문 교수는 실망될 수는 있겠지만 또 다른 기회를 만들어 낼 수/ 창출 할 수 있다고 믿습니다. "그런 일이 일어 날 때 나는 매우 좋아합니다.  우리가 뭔가를 하고 있다는 것을 의미하기 때문입니다"라고 Porter교수는 말합니다. "Kristy는 데이터가 우리에게 무엇을 말하는 지 실제로 보고 있습니다."</p>

								<p>권 은 봄 학기에 논문을 변호 할 것이며, 대학 도서관을 통해 학부 학술 연구 상을 신청할 계획입니다. 졸업 후, 그녀는 이민법 또는 형법에서 J.D.를 획득하고 소외된 공동체의 삶에 가해지는/끼치는 미 정부 정책의 영향을 연구하기를 희망합니다.</p>

								<p>그녀는 동 아시아 도서관이 그녀의 일에 중요한 도움을 줄뿐만 아니라 그녀에게 소중한 주제를 추구 할 수있는 연결점을 제공한다고 평가합니다.   "한국이 여성에 대한 긍정적 변화를 보장하는 많은 법을 만들었지 만 충분하지 않다는 것을 보여주기 위해 이 연구를 사용하고 싶다"고 권 은 말합니다. "우리는 이러한 대화를 계속 해야 합니다."</p>

								<p>권 (Kwon)과 같은 학생들은 대학 도서관을 통해 전 세계의 모든 형식의 지식을 접할 수 있습니다. 학부 연구로 시작하는 여정은 세상을 변화시킬 수 있습니다.</p>
							</div>
						</div>
					</div>
				</div> 
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 copy">
						<h2>역사적인 소장품 보존</h2>
						<p>크리스티 권 (Kristy Kwon)이 연구에 사용했던 광범위한 한국 소장품은/콜렉션은 동아시아 도서관의 목록 작성자이기도 한 류혜자(Heija Ryoo)씨와 같은 기증자들 덕분에 유지되고 있습니다.</p>

						<p>류씨는 한국 콜렉션에 적체 된 소장품들이 누적 된 것을 보았을 때 기회가 있음을 보았습니다.  사서 이효경과 공동으로 한국 카탈로그 기금을 설립했습니다.  관대한 지역 기부자들이 지원 한 이 기금은 동 도서관이 대학 도서관 온라인 데이터베이스와 국제 서지/도서 목록 데이터베이스 인 WorldCat에 적체된 항목을 입력 할 수 있게 해 줍니다. 이러한 자료는 수십 년 만에 처음으로 전세계 학생, 연구원, 교직원 및 기타 사용자가 사용할 수 있게 되었습니다.</p>

						<p>도서관의 노력은 이미 주목을 받고 있습니다. 한국의 국립 중앙 도서관에서 찾아 온 방문객들은 이 도서관 소장품속에 숨겨져 있는 보물이 있는지 보기 위해 도서관을 방문했습니다.</p>

						<p>류씨는 "이 소장픔들이 차세대를 위해 보존 될 것 임을 사람들이 아는 것이 자산 입니다. "2 세대, 3 세대 한국계 미국인은 미국 내 어느 곳에서도 이용할 수 없는 이런 자료들을 찾을 수 있습니다."</p>
