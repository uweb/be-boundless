      ...
      <div class="scrollContent" id="slides">
        ...
        ><section tabindex="0"  class="section" id="slide4" data-img="/wp-content/themes/be-boundless/campaign/img/camp-bg4.jpg">
          <div id="slide4text">
            ...
            <a href="supporting-the-student-experience" data-js="scholarship" data-title="Transform the student experience" class="uw-btn btn-sm btn-plus story-link">Read story</a> <a href="passion" class="uw-btn btn-sm">Opportunities</a>          
          </div>
          ...
          <div id="slide5text">
            ...
            <a href="expanding-education" data-js="education" data-title="Drive the public good" class="uw-btn btn-sm btn-plus story-link">Read story</a> <a href="passion" class="uw-btn btn-sm">Opportunities</a>
          </div>
          ...
          <div id="slide6text">
            ...
            <a href="targeting-cancer" data-js="medicine" data-title="Expand our impact everywhere" class="uw-btn btn-sm btn-plus story-link">Read story</a> <a href="passion" class="uw-btn btn-sm">Opportunities</a>
          </div>
          ...
          <div id="slide7text">
            ...
            <a href="inclusive-engineering" data-js="engineering" data-title="Empower possibility through innovation" class="uw-btn btn-sm btn-plus story-link">Read story</a> <a href="passion" class="uw-btn btn-sm">Opportunities</a>
          </div>
