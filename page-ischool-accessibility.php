...
<main id="main_content">
      ...
      <section class="text-block yellow section-1">
        ...
        <div class="b-2">
          <blockquote>For those who live with cerebral palsy, touch might look like patting the screen with the back of the hand, or dragging a palm or a fist.</blockquote>
        </div>
        ...
        <div class="block">
          ...
          <div class="b-1">
            ...
            <div>
              ...
              <p>Think of it as the counterpart to automated speech recognition, where the device asks you to repeat a few phrases so it can pick up on your unique speech patterns. In Mott’s model, the device asks you to touch a couple targets — a balloon or a bull’s-eye, for example — so it can pick up on your unique touch patterns and adjust how it responds. </p>

              <p>And it’s all guided by Mott’s participants, who give him real-life, real-time feedback. </p>

              <p><b>Meet Martez Mott</b></p>
              <ul>
                <li>Hometown: Detroit</li>
                <li>Bachelor of Science in Computer Science, Bowling Green State University, ‘10</li>
                <li>Master of Science in Computer Science, Bowling Green State University, ‘12</li>
                <li>Ph.D. candidate in Information Science, University of Washington</li>
              ...
              <div class="row">
                  <div class="col-md-10 col-md-offset-1 copy ">
                    <div style="text-align: center">             
                      ...
                      <p>You can be part of Mott’s project and help iSchool students like him make technology accessible for everyone at the MAD (Mobile + Accessible Design) Lab by making a gift to the Human Computer Interaction Research Fund.</p>
