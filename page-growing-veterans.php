<?php
	$twitter_photo = '';
	$twitter_title = 'Seeds of hope';
	$twitter_description = 'In the name of holistic mental health, Christopher Brown, ’16, created Growing Veterans, a sustainable farming organization that reconnects veterans to each other — and to life.';
