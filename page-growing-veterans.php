...
<?php echo do_shortcode('[slideshow id=3109 simple=true]');?>
 ...
 -->
    ...
    <!-- Who we are Section -->
      <section class="content-section text-center audio-block">
          <div class="who-section">
              ...
              <ul id="people">
                  <li class="pax-1 army" tabindex="0">
                      <div class="hider">
                          <h4>Mike</h4>
                          <p><span>Service: </span>Army</p>
                          <p><span>Years:</span>1973-1979</p>
                          <div class="audio"><p class="length">1:21 <span>/ play interview</span></p>
                            ...
                            <div class="visually-hidden audio-transcript" tabindex="0">
                              <p><b>Shoah</b>: I’m Shoah. I’m writing about bowling, ‘cause I think it’s really fun to play. </p>
                              <p><b>Question</b>: What’s your favorite thing about going to PSIS?</p>
                              <p><b>Shoah</b>: Probably P.E. Jovan’s grandpa is a good P.E. teacher. When football’s going I like to watch Denver, Green Bay and Seattle. </p>
                              <p><b>Question</b>: Who’s your favorite football team?</p>
                              <p><b>Shoah</b>: Denver! It’ll take all of ‘em over.</p>
                            </div>
                            <p class="audio-buttons">
                              <button class="audio-ctrl audio-play" tabindex="0">1:21 / PLAY INTERVIEW</button>  
                  ...
                  <li class="pax-2 navy" tabindex="0">
                      <div class="hider">
                          <h4>Sean</h4>
                          <p><span>Service: </span>Army</p>
                          <p><span>Years:</span>1973-1979</p>
                  ...
                  <li class="pax-3 marines" tabindex="0">
                      <div class="hider">
                          <h4>Chris</h4>
                          <p><span>Service: </span>Army</p>
                          <p><span>Years:</span>1973-1979</p>
                  ...
                  <li class="pax-4 airforce" tabindex="0">
                      <div class="hider">
                          <h4>Kenny</h4>
                          <p><span>Service: </span>Army</p>
                          <p><span>Years:</span>1973-1979</p>
                  ...
                  <li class="pax-6 navy" tabindex="0">
                      <div class="hider">
                          <h4>Joel</h4>
                          <p><span>Service: </span>Army</p>
                          <p><span>Years:</span>1973-1979</p>
          ...
          <div class="row">
            <div class="col-md-10 col-md-offset-1 copy">             
               ...
               <p> A newly minted graduate, Brown recently transitioned from executive director of Growing Veterans to president of the board of directors — freeing up time to launch his career as a PTSD counselor for veterans.</p>
                ...
                <p>Brown says the UW’s highly flexible M.S.W. extended degree program gave him much more than just the tools and credentials he needed to be a counselor.</p> 
    ...
    <section class="text-block">
      ...
      <!-- **** JS **** -->      
      <!-- <script src="<?php echo get_stylesheet_directory_uri() . '/immersive-stories/js/hunt.min.js' ?>" type="text/javascript"></script> -->
      <!-- <script src="<?php echo get_stylesheet_directory_uri() . '/immersive-stories/js/jquery.animateNumber.min.js' ?>" type="text/javascript"></script> -->
