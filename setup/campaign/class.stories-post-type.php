...
if ( ! post_type_exists( 'stories' ) ):
  ...
  function campaign_stories_shortcode( $atts )
  {
    ...
    $args = array(
        ...
        'nopaging'  => true,
        'meta_query' => array(
            'key'  => 'exclude',//check exclude checkbox
            'value' => !'on',
            'compare' => 'NOT LIKE',//test = not on
        ),
        'order'     => 'ASC',
        'orderby'   => 'menu_order',
    );
    ...
    $return .= '</div></div>' .
                '<button class="left stories-control prevSlide">' .
                    //'<span>' .
                        ...
                        // '</svg>' .
					// '</span>' .
					'<img src="' . get_stylesheet_directory_uri() . '/campaign/img/arrow_left.png" alt="Previous Slide" />' .
                '</button>' .
                '<button class="right stories-control nextSlide">' .
                    // '<span>' .
                        ...
                        // '</svg>' .
					// '</span>' .
					'<img src="' . get_stylesheet_directory_uri() . '/campaign/img/arrow_right.png" alt="Next Slide" />' .
                '</button>' .
              '</div></section>';
