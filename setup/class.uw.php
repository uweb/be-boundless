...
class UW
{
    ...
    private function includes()
    {
        ...
        if ($parent == $child){
            $parent = get_template_directory() . '/../uw-2014/setup/';
        }
        require_once($parent . 'class.install.php');
        require_once($parent . 'class.uw-scripts.php');
        require_once($child  . 'class.uw-boundless-scripts.php');
        require_once($parent . 'class.uw-styles.php');
        require_once($child  . 'class.uw-boundless-styles.php');
    ...
    private function initialize()
    {
        ...
        $this->Scripts           = new UW_Boundless_Scripts;
