<?php
	$twitter_photo = 'http://www.washington.edu/wp-content/themes/be-boundless/immersive-stories/img/education/twitter-card.jpg';
	$twitter_title = 'Nurturing minds, opening doors';
	$twitter_description = 'In South Seattle and South King County, the UW College of Education is partnering with the Road Map Project to close achievement gaps in schools — and open doors for all young learners.';
...
<div class="school-zoom">
  ...
  <p class="blurb1">Lakeridge is one of the most diverse public schools in Washington: Nearly 90 percent of the students are Black, Latino or Asian.</p>
  <p class="blurb2">About half of the students speak a language other than English at home, and roughly 90 percent are eligible for free or reduced-price school meals. </p>
...
<p>“We were heartbroken,” recalls Brown. “We had been working really hard on reading, and saw scores improve. But then we got the news that it still wasn’t enough.”</p>
        ...
        <section class="profile person-2 teacher right">
          <div class="skew"><div></div></div>
          <h2 class="name">Nicole Brown</h2>
          <p class="studies">2nd-grade teacher</p>
        ...
        <section class="profile person-1 teacher">
          <div class="skew"><div></div></div>
          <h2 class="name">Kert Lin</h2>
          <p class="studies">4th-grade teacher</p>
          <p class="studies">Lakeridge Elementary</p>
           ...
           <div class="row">
               <div class="col-md-10 col-md-offset-1 copy">
                 <div style="text-align: center">
                   ...
                   <p>The University of Washington is undertaking its most ambitious campaign ever: Be Boundless &mdash; For Washington, For the World. You can help the College of Education drive the public good by contributing to these funds.</p>
