      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1 copy">
            ...
            <p>She may even be watching a 360-degree film created by <a href="http://www.electricdreamfactory.com/">Electric Dream Factory</a>, a content studio that works with diverse creatives to tell stories through <span data-tooltip="Virtual Reality (VR): 360-degree video and/or computer-generated simulations that immerse users in a different world. Examples of VR hardware range from Google Cardboard to Oculus Rift headsets.
            &#013;&#10;
            Augmented Reality (AR): Technology that overlays digital information onto the real world in real time.
            &#013;&#10;
            Mixed Reality (MR): Like AR, MR combines digital information with the real world. The two terms are often used interchangeably, but a key distinction is that MR allows the physical and digital worlds to interact in real time — so virtual objects are treated as if they are actually present." data-tooltip-position="top" data-html="true">virtual, augmented and mixed reality</span>.</p>

            <p>Founded by producer Lacey Leavitt, ’03, and editor Joe Jacobs, Electric Dream Factory moved into this workspace in 2016. Since then, they’ve created several virtual reality films — and as they harness the power of technology to help storytellers from different backgrounds make an impact on audiences, they’re benefiting from a startup incubator that shares their philosophy of <span data-tooltip="Inclusive Innovation: The philosophy that including people from all backgrounds strengthens innovation and changes lives for the better.
            &#013;&#10;
            Creating a space and opportunity for this cross-pollination of ideas is core to the UW’s Innovation Imperative — an integrated approach that will drive positive change in our state and beyond." data-tooltip-position="top" data-html="true">inclusive innovation</span>.</p>
            ...
            <p>Eventually, both Leavitt and Jacobs made their way back to Seattle, where they teamed up in 2015 to form the company they now call Electric Dream Factory. It wasn’t long before they took another plunge: In addition to continuing their work on feature films, they ventured into <span data-tooltip="Cross Reality (XR): Any experience that combines digital and “real,” or physical, reality. This term is often used to encompass virtual-, augmented- and mixed-reality technology." data-tooltip-position="top" data-html="true">cross reality</span> (XR) filmmaking, with a focus on virtual reality (VR).</p>
                  ...
                  <div class="hidden-part">
                    ...
                    <div class="row">
                      ...
                      <div class="item-desc col-md-6 col-sm-8 col-xs-10 col-sm-offset-0 col-xs-offset-1"> 
                        ...
                        <p>In 1838, British physicist Sir Charles Wheatstone publishes a paper explaining how the mind combines images from each eye to create depth perception. He coins it the “stereoscope,” and by mid-19th century it has been adapted for handheld use and gained significant popularity.</p>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 col-sm-4 col-xs-10 col-sm-offset-0 col-xs-offset-1">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1 copy">
            ...
            <p><b>CoMotion</b> seeks to expand the economic and social impact of the UW community by fostering innovation transfer, which helps researchers make the leap from idea to impact; creating strategic partnerships, such as the Global Innovation Exchange and Amazon Catalyst; and encouraging innovative thinking through workshops, trainings and events for the UW and our broader community.
