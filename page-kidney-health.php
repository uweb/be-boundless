				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 copy">
						...
						<div class="center-block">
							<img src="<?php echo get_stylesheet_directory_uri() ?>/immersive-stories/img/pharmacy/img-scientistatdesk.jpg" alt="Team member Jonathan Himmelfarb, M.D., holds an early prototype of kidney-on-a-chip." class="img-responsive center-block" />
		...
		<section class="text-block graphpaper-white first">
			<div class="container">
				<div class="row">
					...
					</div><!-- .col-md-7 .two-column-copy-right -->
				</div><!-- .row -->
			</div><!-- .container -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 copy">
						...
						<p>Thummel brings to the project his experience in keeping astronauts healthy. With a long-standing research interest in vitamin D metabolism and the regulation of mineral homeostasis, a key component of kidney function, Thummel was previously part of a special National Research Council committee that established guidelines for chemical exposure in spacecraft air and water.</p>
