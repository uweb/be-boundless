...
if (true) {
    ...
    $(window).load(function(){
      ...
      $( ".pause" ).click(function(e) { 
      	$this = $(e.target);
      	$vid = $(e.target).parent().find('video');
      ...
      .on("progress", function (event) {
          ...
          videdo.currentTime = Math.floor(change);
      });
      ...
      var tl = new TimelineMax();
          tl
          .from($("#intro").find(".one"), 4, {opacity:0, scale:.8})
          .from($("#intro").find(".two"), 4, {opacity:0, y: '100%'});
      ...
      var tl = new TimelineMax();
          tl
          .from($("#unexpected").find(".middle"), .5, {y:"-100%"})
          .from($("#unexpected").find(".middle .fun"), .5, {opacity:0})
          .from($("#unexpected").find(".pluses"), .5, {opacity: 0});
      ...
      .addTo(controller);
      $(window).resize(function(){
          unexpected.offset(-$(window).height()*.25);
      ...
      var tl = new TimelineMax();
          tl
          .from($("#slideplay").find(".possible"), .25, {opacity: 0})
          .from($("#slideplay").find(".click"), .25, {opacity: 0})
          .to($("#slideplay").find(".ring svg"), .5, {rotation: 360});
      ...
      .addTo(controller);
      $(window).resize(function(){
          slideplay.offset(-$(window).height()*.25);
      ...
      var tl = new TimelineMax();
          tl
          .from($("#surprise").find(".text"), .25, {opacity: 0})
          .from($("#surprise").find(".other"), .25, {opacity: 0})
      ...
      .addTo(controller);
      $(window).resize(function(){
          surprise.offset(-$(window).height()*.25);
    ...
    var tl = new TimelineMax();
      tl
      .from($("#ispossible").find(".input"), .25, {opacity: 0})
      .from($("#ispossible").find(".text"), .25, {opacity: 0})
      .from($("#ispossible").find(".other"), .25, {opacity: 0});
    ...
    .addTo(controller);
    $(window).resize(function(){
        isPossible.offset(-$(window).height()*.25);
      ...
      $("#slideplay").on("click", function(){
          ...
          if(first){
              setTimeout(function(elem){
                  $(elem).find("video").get(0).paused ? $(elem).find("video").get(0).play() : $(elem).find("video").get(0).pause();
              }, 600, this);
              first = false;
          }else{
              $(this).find("video").get(0).paused ? $(this).find("video").get(0).play() : $(this).find("video").get(0).pause();
          }
      });
