...
//     'use strict';
    ...
    // $.fn.fullpage = function(options) {
        ...
        isScrollAllowed.k = isScrollAllowed.m;
        ...
        */
        function moveSectionUp(){
            ...
            //CHECK FOR HEADER
            var index = $(SECTION_ACTIVE_SEL).next(SECTION_SEL).index(SECTION_SEL);
            if(index == 1) {
        ...
        */
        function moveSectionDown(){
            ...
            //CHECK FOR HEADER
            var index = $(SECTION_ACTIVE_SEL).index(SECTION_SEL);
            if(index == 1) {
                $('#immersive').toggleClass("hide-menu");
        ...
        */
        function scrollPage(element, callback, isMovementUp){
            ...
            if((v.activeSection.is(element) && !isResizing) ){ return; }//|| (options.scrollBar && $window.scrollTop() === v.dtop && !element.hasClass(AUTO_HEIGHT) )){ return; }
        ...
        */
        ...
        function keydownHandler(e) {
            ...
            if(!activeElement.is('textarea') && !activeElement.is('input') && !activeElement.is('select') &&
                ...
                var keyControls = [40, 38, 33, 34]; //removed 32 (spacebar)
