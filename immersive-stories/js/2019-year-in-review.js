$(function () {
    ...
    $(window).scroll(function () {
        ...
        // diver photo
        if (blurScroll > (diverPhoto - $('#flex-content-section-1 img').height() / 2) && (blurScroll < (diverPhoto + $('#flex-content-section-1 img').height()))) {
        ...
        // crew photo
        if (blurScroll > (crewPhoto - $('#flex-content-section-5 img').height() / 2 ) && (blurScroll < (crewPhoto + $('#flex-content-section-5 img').height()))) {
        ...
        // forest photo
        if (blurScroll > (forestPhoto - $('#flex-content-section-8 img').height() / 2) && (blurScroll < (forestPhoto + $('#flex-content-section-8 img').height()))) {
		...
		// microplastics photo
		if (blurScroll > (microplasticsPhoto - $('#flex-content-section-16 img').height() / 2) && (blurScroll < (microplasticsPhoto + $('#flex-content-section-16 img').height()))) {
