  ...
  <div class="intro-body">
      <div class="row">
        <div class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-1 col-lg-offset-1" id='intro-text'>
            <h1><span><span>Targeting cancer, </span></span><span><span>precisely</span></span> </h1>
...
<main id="main_content">
    ...
    <section class="text-block">
      ...
      <section class="profile person-1 teacher"><div class="background-profile"><div class="transform">
                    ...
                    <div class="name-wrap">
                      <h2 class="name">PAMELA BECKER</h2>
                      <p class="title">M.D., Ph.D.</p>
                      <p class="studies">Professor of Medicine, <br>Division of Hematology</p>
                    </div>
                    <div class="audio"><p class="length">1:09 <span>/ play interview</span></p>
                      <audio controls class="player">
                        <source src="<?php echo get_stylesheet_directory_uri() . '/immersive-stories/audio/medicine/AUDIO_BECKER_SHORT.mp3' ?>" type="audio/mpeg">
            ...
            <div style="text-align: center"><div class="boundless-button sm dark"><span><a id="expander" href="http://www.uwmedicine.org/bios/pamela-becker">Learn more about Dr. Becker</a></span></div></div>
...
<p class="gold-quote headline-gold purple">“I look forward to a day when 100 percent of our AML patients live for five years, rather than just 25 percent,” says Dr. Becker. “A future where we don’t ever have to lose a person to this disease again.”</p>
                ...
                <section class="profile person-2 teacher right"><div class="background-profile">
                        <div class="skew"><div></div></div>
                        <div class="name-wrap">
                      ...
                      <div class="row">
                          <div class="col-md-10 col-md-offset-1 copy">
                            ...
                            <div class="callout">
                              ...
                              <ul>
                               <li>UW faculty: <span>117</span></li>
                                <li>Patents issued: <span>398</span></li>
                                <li>Companies started: <span>20</span></li>
