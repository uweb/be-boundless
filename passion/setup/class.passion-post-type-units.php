...
if ( ! post_type_exists( 'units' ) ):
	...
	function save_unit_details() {
		...
		if (get_post_type($post) == 'units') {
			...
			$url = !strpos( $_POST['url'] , 'http' ) ? "http://" . $_POST['url'] : $_POST['url'];
			$volunteer = !strpos( $_POST['volunteer'] , 'http' ) ? "http://" . $_POST['volunteer'] : $_POST['volunteer'];
			$leadership = !strpos( $_POST['leadership'] , 'http' ) ? "http://" . $_POST['leadership'] : $_POST['leadership'];
