...
<div class="intro" id="intro-vid">
    <div id="slide">
      <h1>Powering policy at home and abroad</h1>  
      <hr> 
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1 copy">
                    ...
                    <p>From making agricultural investments in developing countries to passing laws in Washington state, research undertaken by Evans School faculty with assistance from graduate students informs policymaking around the world. </p>
                    <p>Ph.D. student Hilary Wething and M.P.A. candidate Matthew Fowle are making the most of their experiences at the UW, thanks to the generosity of donors. They’re taking part in research opportunities with real-world influence: Wething studies the effects of Seattle’s historic minimum wage law, and Fowle is working to find evidence-based solutions to reduce poverty in third-world countries.</p>
                    ...
                    <h2 class="slant"><span><span>Impact</span></span> at home</h2>
                    ...
                    <p>When the new law took effect the following year, policymakers were entering uncharted waters, as were workers and businesses. No one knew how the increase would affect people in a city with a skyrocketing cost of living.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1 copy">
                  ...
                  <p>Over two years, their team conducted two waves of interviews with 55 local low-income workers. All 55 participants have children, and more than half are immigrants. At the start of the study, all were working for no more than $15 per hour. </p>
                  ...
                  <p>As the team embarks on the final wave of interviews this spring, Wething and Hill hope their data will help create a more complete picture in conjunction with the analysis of state administrative data and survey responses from employers. </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1 copy reduced-pad">
                  ...
                  <p>Fowle and his EPAR team members trawled through data from four South Asian and four Sub-Saharan countries to determine both why people adopt mobile money services and how they regularly use it. </p>
                  
                  <p>In just the eight years since EPAR has been in operation, Anderson has seen the immense benefit of the EPAR experience to students’ careers. “Combined with their Evans School professional training, this makes them phenomenal researchers. They learn great technical tools for finding, analyzing and communicating information; they learn from each other; and they push themselves beyond the threshold of what’s considered ‘quality’ work,” she says. “And they get hired very quickly after they graduate; it’s a problem for us every June — we lose these students to great places,” she adds with a laugh.</p>
                  ...
                  <p>EPAR alumni have taken up positions with USAID, the Center for Global Development, the Research Triangle Institute and PATH.</p>
                  ...
                  <p>Both Wething’s and Fowle’s extraordinary experiences have been fueled by the generosity of donors, whose gifts make student scholarships, fellowships and faculty professorships possible.</p>
